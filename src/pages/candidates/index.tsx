...
export function CandidateListPage(props: CandidateListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getCandidates({
        relations: ['user', 'election', 'vote.count'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['campaign_statement.contains', 'election_position.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'campaign_statement', header: 'Campaign Statement', accessorKey: 'campaign_statement' },
    { id: 'votes_received', header: 'votes_received', accessorKey: 'votes_received' },
    { id: 'election_position', header: 'Election Position', accessorKey: 'election_position' },
