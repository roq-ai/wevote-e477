...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'A Student Voter has cast a vote in the election.create': {
    roles: ['administrator'],
    key: 'vote_cast',
    tenantPath: [],
    userPath: [],
  },
  'An Administrator has added a new candidate to the election.create': {
    roles: ['administrator', 'student-voter'],
    key: 'candidate_added',
    tenantPath: [],
    userPath: [],
  },
  'An Administrator has closed the election.update': {
    roles: ['administrator', 'student-voter', 'candidate'],
    key: 'election_closed',
    tenantPath: [],
    userPath: [],
  },
...
const tenantRoles: string[] = ['administrator', 'student-voter', 'candidate'];
